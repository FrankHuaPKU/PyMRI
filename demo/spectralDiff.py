...
def convergence_study(func, func_name, N_values, save_dir='outputs'):
    ...
    # 绘制收敛性图
    plt.figure(figsize=(12, 6))
    plt.loglog(N_values, errors_spec64, 'r.-', label='Spectral (FP64)', linewidth=2, markersize=8)
    plt.loglog(N_values, errors_spec32, 'r:', label='Spectral (FP32)', linewidth=2, markersize=8)
    plt.loglog(N_values, errors_cd64, 'b.-', label='Central Diff (FP64)', linewidth=2, markersize=8)
    plt.loglog(N_values, errors_cd32, 'b:', label='Central Diff (FP32)', linewidth=2, markersize=8)
